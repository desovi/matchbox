...
export function CreateBracketWizard({ onBracketInfoChange }) {
  ...
  const [tournamentTeams, setTournamentTeams] = useState([
    { player1: "김민수", player2: "이지은" },
    { player1: "박준호", player2: "최수진" },
    { player1: "정현우", player2: "한소영" },
    { player1: "윤태영", player2: "강미라" },
    { player1: "조성민", player2: "임하늘" },
    { player1: "오동현", player2: "신유진" },
    { player1: "배진호", player2: "류지혜" },
    { player1: "서민석", player2: "문지영" },
    { player1: "남도현", player2: "안서연" },
    { player1: "홍성진", player2: "전나영" },
    { player1: "유재호", player2: "노은지" },
    { player1: "송민규", player2: "권혜진" },
    { player1: "황동욱", player2: "고미영" },
    { player1: "백준호", player2: "신지은" },
    { player1: "엄태현", player2: "양수진" },
    { player1: "구민수", player2: "나지영" },
    { player1: "도현우", player2: "라소영" },
    { player1: "마태영", player2: "바미라" },
    { player1: "사성민", player2: "아하늘" },
    { player1: "자동현", player2: "차유진" },
    { player1: "카진호", player2: "타지혜" },
    { player1: "파민석", player2: "하지영" },
    { player1: "허도현", player2: "호서연" },
    { player1: "김성진", player2: "이나영" },
    { player1: "박재호", player2: "최은지" },
    { player1: "정민규", player2: "한혜진" },
    { player1: "윤동욱", player2: "강미영" },
    { player1: "조준호", player2: "임지은" },
    { player1: "오태현", player2: "신수진" },
    { player1: "배민수", player2: "류지영" },
    { player1: "서도현", player2: "문서연" },
    { player1: "남성진", player2: "안나영" },
    { player1: "홍재호", player2: "전은지" },
    { player1: "유민규", player2: "노혜진" },
    { player1: "송동욱", player2: "권미영" },
    { player1: "황준호", player2: "고지은" },
    { player1: "백태현", player2: "신수진2" },
    { player1: "엄민수", player2: "양지영" },
    { player1: "구도현", player2: "나서연" },
    { player1: "도성진", player2: "라나영" },
    { player1: "마재호", player2: "바은지" },
    { player1: "사민규", player2: "아혜진" },
    { player1: "자동욱", player2: "차미영" },
    { player1: "카준호", player2: "타지은" },
    { player1: "파태현", player2: "하수진" },
    { player1: "허민수", player2: "호지영" },
    { player1: "김도현2", player2: "이서연" },
    { player1: "박성진2", player2: "최나영" },
    { player1: "정재호2", player2: "한은지" },
    { player1: "윤민규2", player2: "강혜진" },
    { player1: "조동욱2", player2: "임미영" },
    { player1: "오준호2", player2: "신지은2" },
    { player1: "배태현2", player2: "류수진" },
    { player1: "서민수2", player2: "문지영2" },
    { player1: "남도현2", player2: "안서연2" },
    { player1: "홍성진2", player2: "전나영2" },
    { player1: "유재호2", player2: "노은지2" },
    { player1: "송민규2", player2: "권혜진2" },
    { player1: "황동욱2", player2: "고미영2" },
    { player1: "백준호2", player2: "신지은3" },
    { player1: "엄태현2", player2: "양수진2" },
  ]);
